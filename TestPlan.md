...
| Defect ID | ID | Project                           | Step                 | Description                                                                                                                                                                                                                                                               | Issue | Remarks                                                                                                                 |
|-----------|----|-----------------------------------|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|-------------------------------------------------------------------------------------------------------------------------|
| 1         | 2  | SharedApp/BlankSharedApp1.Windows | Add Header    | Error message "No License Header Definition File found in Project" appears                                                                                                                                                                                                |       | There exists a linked .header file in the project. When does this Window appears, what is the desired behaviour? |
...
| 5         | 9  | PythonApplication1                | Add Header    | Error message "No License Header Definition File found in Project" appears                                                                                                                                                                                                |       | There exists a linked .header file in the project. When does this Window appears, what is the desired behaviour? |
| 6         | 11 | TypeScriptHTMLApp1                | Remove Header | One .header definition contains an extra newline before the next extensions are defined. When removing the header, an extra newline is added right after the removed header. This extra newline gets deleted again when re-adding the .header |       |                                                                                                                         |
