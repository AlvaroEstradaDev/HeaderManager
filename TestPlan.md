...
Open the TestSolution with the to be tested HeaderManager Version and follow the documented steps. Have your preferred Git GUI open to check if there are changes made and check visually if the expected files are the same as documented


## Quick Test

| ID | Right-Click project file          | Remove Headers - changed files | Add Headers                                      | Add Headers again         |
|----|-----------------------------------|---------------------------------------|---------------------------------------------------------|----------------------------------|
...
| ID | Right-Click solution | Remove Headers - changed files | Add Headers - click "no" on dialog | Add Headers again - click "no" on dialog |
|----|----------------------|---------------------------------------|-------------------------------------------|-------------------------------------------------|
...
| Defect ID | ID | Project    | Step                | Description                                                                                                                                                         | Issue | Remarks |
|-----------|----|------------|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|---------|
| 1         | 6  | OfficeApp1 | Add Headers  | One file remains changed, but it is a file from OfficeApp1Web Project, which seems unrelated to current Project. Error is also happening with 2.0.0, so no new bug. |

## 1.7.3

| Defect ID | ID | Project            | Step                                            | Description                                                                                            | Issue            | Remarks |
|-----------|----|--------------------|-------------------------------------------------|--------------------------------------------------------------------------------------------------------|------------------|---------|
| 1         | 12 | LHM-CsProjTest     | Add Headers again (click "no" on dialog) | On files where a skip expression is defined, LHM tries to remove an extra NewLine when readding the LH | #62              |         |
| 2         | 6  | OfficeApp1         | Add Headers again                        | Same as Defect 1                                                                                       | Same as Defect 1 |         |
| 3         | 11 | TypeScriptHTMLApp1 | Add Headers again                        | Same as Defect 1                                                                                       | Same as Defect 1 |

## 1.7.2

| Defect ID | ID | Project                           | Step                 | Description                                                                                                                                                                                                                                                               | Issue | Remarks                                                                                                                 |
|-----------|----|-----------------------------------|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|-------------------------------------------------------------------------------------------------------------------------|
| 1         | 2  | SharedApp/BlankSharedApp1.Windows | Add Header    | Error message "No License Header Definition File found in Project" appears                                                                                                                                                                                                |       | There exists a linked .licenseheader file in the project. When does this Window appears, what is the desired behaviour? |
| 2         | 3  | App1                              | Add Header    | Whitespace is added into app.config after skipped expression                                                                                                                                                                                                              | #59   |                                                                                                                         |
| 3         | 5  | LHM-CsProjTest                    | Add Header    | Whitespace is added into .xml file after skipped expression                                                                                                                                                                                                               | #59   |                                                                                                                         |
| 4         | 7  | OfficeApp1Web                     | Add Header    | Visual Studio freezes                                                                                                                                                                                                                                                     |       | Did happen just once                                                                                                    |
| 5         | 9  | PythonApplication1                | Add Header    | Error message "No License Header Definition File found in Project" appears                                                                                                                                                                                                |       | There exists a linked .licenseheader file in the project. When does this Window appears, what is the desired behaviour? |
| 6         | 11 | TypeScriptHTMLApp1                | Remove Header | One .licenseheader definition contains an extra newline before the next extensions are defined. When removing the licenseheader, an extra newline is added right after the removed licenseheader. This extra newline gets deleted again when re-adding the .licenseheader |       |                                                                                                                         |
| 7         | 12 | LHM-CsProjTest                    | Add Header    | Whitespace errors see 1.7.2 Defect number 2/3                                                                                                                                                                                                                             |       |                                                                                                                         |
| 8         | 8  | PHPWebProject1                    | Add Header    | Whitespace is added into .js file after skipped expression                                                                                                                                                                                                                | #59   |